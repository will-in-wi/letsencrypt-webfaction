...
module LetsencryptWebfaction
  class Emailer
    ...
    def initialize(instructions, support_email: '', account_email: '')
    ...
    def send_to_account!
      Pony.mail(to: @account_email, from: @account_email, subject: SUBJECT_MESSAGE, body: @instructions.full_message(support_email: @support_email != ''))
    end
